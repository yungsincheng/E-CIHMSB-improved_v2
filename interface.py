        ...
        if r['type'] == 'text':
            ...
            if is_garbled:
                ...
                <div style="text-align: center;">
                    <p style="font-size: 40px; font-weight: bold; color: #C62828; margin-bottom: 30px;">提取失敗 ({r["elapsed_time"]:.2f} 秒)</p>
                    <p style="font-size: 30px; font-weight: bold; color: #C62828; margin-bottom: 10px;">機密圖像:</p>
                </div>
                ''', unsafe_allow_html=True)
