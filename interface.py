                    ...
                    if verify_img:
                        ...
                        if 'verify_img_result' in st.session_state and st.session_state.verify_img_result:
                            ...
                            if vr.get('same_size'):
                                mse = vr['mse']
                                if mse == 0:
                                    st.markdown('<p style="font-size: 16px; font-weight: bold; color: #4f7343;">完全一致！</p>', unsafe_allow_html=True)
                                else:
                                    st.markdown('<p style="font-size: 16px; font-weight: bold; color: #C62828;">不一致！</p>', unsafe_allow_html=True)
                            else:
